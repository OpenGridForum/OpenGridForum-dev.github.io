...
<form action="/ogf/doku.php/start" method="get" role="search" class="search doku_form" id="dw__search" accept-charset="utf-8"><input type="hidden" name="do" value="search"><input type="hidden" name="id" value="about">

<div class="no"><input name="q" type="text" class="edit" title="[F]" accesskey="f" placeholder="Search" autocomplete="on" id="qsearch__in" value=""><button value="1" type="submit" title="Search">Search</button></div>

</form>

*   [Recent Changes](/ogf/doku.php/about?do=recent "Recent Changes [R]")
*   [Sitemap](/ogf/doku.php/about?do=index "Sitemap [X]")
...
[![](/ogf/lib/exe/fetch.php/ogf_logo.png?w=150&tok=57a181)](http://www.ogf.org/dokuwiki/ "http://www.ogf.org/dokuwiki/")  
...
[Login](/ogf/doku.php/sidebar?do=login "sidebar")  
[Logout](/ogf/doku.php/sidebar?do=logout "sidebar")
...
<form class="button btn_secedit" method="get" action="/ogf/doku.php/sidebar">

<div class="no"><input type="hidden" name="do" value="edit"><input type="hidden" name="rev" value=""><input type="hidden" name="0" value="post"><button type="submit" title="Edit">Edit</button></div>
...
<form class="button btn_secedit" method="get" action="/ogf/doku.php/about/sidebar">
...
<form class="button btn_secedit" method="post" action="/ogf/doku.php/about">

<div class="no"><input type="hidden" name="do" value="edit"><input type="hidden" name="rev" value="1527288918"><input type="hidden" name="summary" value="[Who We Are] "><input type="hidden" name="target" value="section"><input type="hidden" name="hid" value="who_we_are"><input type="hidden" name="codeblockOffset" value="0"><input type="hidden" name="range" value="1-1963"><button type="submit" title="Who We Are">Edit</button></div>
...
<div class="no"><input type="hidden" name="do" value="edit"><input type="hidden" name="rev" value="1527288918"><input type="hidden" name="summary" value="[The OGF Mission] "><input type="hidden" name="target" value="section"><input type="hidden" name="hid" value="the_ogf_mission"><input type="hidden" name="codeblockOffset" value="0"><input type="hidden" name="range" value="1964-2475"><button type="submit" title="The OGF Mission">Edit</button></div>
...
<div class="no"><input type="hidden" name="do" value="edit"><input type="hidden" name="rev" value="1527288918"><input type="hidden" name="summary" value="[Scope] "><input type="hidden" name="target" value="section"><input type="hidden" name="hid" value="scope"><input type="hidden" name="codeblockOffset" value="0"><input type="hidden" name="range" value="2476-3548"><button type="submit" title="Scope">Edit</button></div>
...
<div class="no"><input type="hidden" name="do" value="edit"><input type="hidden" name="rev" value="1527288918"><input type="hidden" name="summary" value="[Delivery] "><input type="hidden" name="target" value="section"><input type="hidden" name="hid" value="delivery"><input type="hidden" name="codeblockOffset" value="0"><input type="hidden" name="range" value="3549-4293"><button type="submit" title="Delivery">Edit</button></div>
...
<div class="no"><input type="hidden" name="do" value="edit"><input type="hidden" name="rev" value="1527288918"><input type="hidden" name="summary" value="[Data Protection and Privacy] "><input type="hidden" name="target" value="section"><input type="hidden" name="hid" value="data_protection_and_privacy"><input type="hidden" name="codeblockOffset" value="0"><input type="hidden" name="range" value="4294-"><button type="submit" title="Data Protection and Privacy">Edit</button></div>
...
*   [Edit this page](/ogf/doku.php/about?do=edit "Edit this page [E]")
*   [Old revisions](/ogf/doku.php/about?do=revisions "Old revisions [O]")
*   [Backlinks](/ogf/doku.php/about?do=backlink "Backlinks")
*   [Manage Subscriptions](/ogf/doku.php/about?do=subscribe "Manage Subscriptions")
*   [Media Manager](/ogf/doku.php/about?do=media&ns= "Media Manager")
*   [Log Out](/ogf/doku.php/about?do=logout&sectok=f2503150ec7f222478463ccd80ef3e0a "Log Out")
*   Logged in as: <bdi>Gregory B. Newby</bdi> (<bdi>gregory.newby</bdi>)
*   [Admin](/ogf/doku.php/about?do=admin "Admin")
*   <bdi>[User page](/ogf/doku.php/user/gregory.newby/start "user:gregory.newby:start")</bdi>
*   [Update Profile](/ogf/doku.php/about?do=profile "Update Profile")
...
<div class="doc"><bdi>about.txt</bdi> · Last modified: 2018/05/25 22:55 by <bdi>alan.sill</bdi></div>

<div class="license">[![CC Attribution-Share Alike 4.0 International](/ogf/lib/images/license/button/cc-by-sa.png)](http://creativecommons.org/licenses/by-sa/4.0/) Except where otherwise noted, content on this wiki is licensed under the following license: <bdi>[CC Attribution-Share Alike 4.0 International](http://creativecommons.org/licenses/by-sa/4.0/)</bdi></div>
...
<div class="no">![](/ogf/lib/exe/indexer.php?id=about&1666558063)</div>
